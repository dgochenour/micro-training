...
void* 
BrakeCommandPlugin_create_typed_datawriter(void *writer)
{
    /* This function is only called from DDS_Publisher_create_datawriter
    * so writer is guaranteed to have a valid (i.e. non-NULL) value 
    */
    DDSDataWriter *cpp_writer = 
    new BrakeCommandDataWriter((DDS_DataWriter*)writer);
...
#ifndef RTI_CERT
void 
BrakeCommandPlugin_delete_typed_datawriter(void *wrapper)
{
    /* This function is only called from DDS_Publisher_create_datawriter
    * and DDS_Publisher_delete_datawriter so wrapper is guaranteed to have
    * a valid (i.e. non-NULL) value 
    */
    ...
    BrakeCommandDataWriter *t_writer = 
    static_cast<BrakeCommandDataWriter *>(cpp_writer);
...
void* 
BrakeCommandPlugin_create_typed_datareader(void *reader)
{
    /* This function is only called from DDS_Subscriber_create_datareader
    * so reader is guaranteed to have a valid (i.e. non-NULL) value 
    */
    DDSDataReader *cpp_reader = 
    new BrakeCommandDataReader((DDS_DataReader*)reader);
...
#ifndef RTI_CERT
void
BrakeCommandPlugin_delete_typed_datareader(void *wrapper)
{
    /* This function is only called from DDS_Subscriber_create_datareader
    * and DDS_Subscriber_delete_datareader so wrapper is guaranteed to have
    * a valid (i.e. non-NULL) value 
    */
    ...
    BrakeCommandDataReader *t_reader = 
    static_cast<BrakeCommandDataReader *>(cpp_reader);
    ...
    void **sample)
{
    ...
    *sample = (void *) BrakeCommand_create();
    return (*sample != NULL);
}
    ...
    const void *src)
{
    ...
    return BrakeCommand_copy(
        (BrakeCommand*)dst,
        (const BrakeCommand*)src);
}
/* --------------------------------------------------------------------------
*  Type BrakeCommand Plugin Instantiation
* -------------------------------------------------------------------------- */

NDDSCDREncapsulation BrakeCommandEncapsulationKind[] =
{ 
    {
        DDS_ENCAPSULATION_ID_CDR_LE,
        DDS_ENCAPSULATION_ID_CDR_BE,
...
NDDSCDREncapsulation BrakeCommandV2EncapsulationKind[] =
{ 
    {
...
MUST_CHECK_RETURN RTI_PRIVATE RTI_BOOL
BrakeCommandTypePlugin_initialize_sample(struct DDS_TypePlugin *plugin, void *buffer)
{
    UNUSED_ARG(plugin);
    return BrakeCommand_initialize((BrakeCommand*)buffer);
}

RTI_PRIVATE RTI_UINT32 
BrakeCommand_get_user_sample_size(
    struct DDS_TypePlugin *tp)
{
    UNUSED_ARG(tp);        
    return sizeof(BrakeCommand);
}

MUST_CHECK_RETURN RTI_PRIVATE RTI_BOOL
BrakeCommand_cdr_initialize(void *init_config, void *buffer)
{
    struct DDS_TypePluginDefault *plugin = (struct DDS_TypePluginDefault*)init_config;
    void *sample;
    struct DDS_TypePluginSampleHolder *sh = (struct DDS_TypePluginSampleHolder*)buffer;

    if (!BrakeCommandPlugin_create_sample(&plugin->_parent,&sample))
    {
        return RTI_FALSE;
    }
...
MUST_CHECK_RETURN RTI_PRIVATE RTI_BOOL
BrakeCommand_cdr_finalize(void *finalize_config, void *buffer)
{
    struct DDS_TypePluginDefault *plugin = (struct DDS_TypePluginDefault*)finalize_config;
    struct DDS_TypePluginSampleHolder *sh = (struct DDS_TypePluginSampleHolder*)buffer;

    if (!BrakeCommandPlugin_delete_sample(&plugin->_parent,sh->sample))
    {
        return RTI_FALSE;
    }
...
RTI_PRIVATE void 
BrakeCommandTypePlugin_return_sample(
    struct DDS_TypePlugin *tp,
    struct DDS_TypePluginSampleHolder *sample)
{
    BrakeCommand_finalize_optional_members((BrakeCommand*)sample->sample, RTI_FALSE);
    XCDR_GenericStreamPlugin_return_sample(tp, sample);
}

RTI_PRIVATE struct DDS_TypeMemoryPlugin*
BrakeCommandXTypesHeapPlugin_create(
    struct DDS_TypePlugin *tp,
    DDS_DomainParticipant *participant,
    struct DDS_DomainParticipantQos *dp_qos,
    DDS_TypePluginMode_T endpoint_mode,
    ...
    DDS_TypePluginEndpointQos *qos)
{
    return DDS_XTypesHeapPlugin_create(
        ...
        NULL,
        NULL,
        BrakeCommand_cdr_initialize,
        BrakeCommand_cdr_finalize,
        sizeof(BrakeCommand),
        RTI_FALSE
        );
}

RTI_PRIVATE struct DDS_TypeMemoryI BrakeCommand_fv_XTypesHeapPluginI =
{
    RTI_MEMORY_MANAGER_HEAP,
    RTI_MEMORY_TYPE_HEAP,
    BrakeCommandPlugin_create_sample,
...
RTI_PRIVATE DDS_Boolean 
BrakeCommand_on_type_registered(struct DDS_TypeImpl* type_impl)
{
    struct RTIXCdrInterpreterPrograms *programs = NULL;
    struct RTIXCdrInterpreterProgramsGenProperty programProperty =
    RTIXCdrInterpreterProgramsGenProperty_INITIALIZER;
    ...
    programs = RTIXCdrInterpreterPrograms_new(
        (RTIXCdrTypeCode *)BrakeCommand_get_typecode(),
        &programProperty,
        RTI_XCDR_PROGRAM_MASK_TYPEPLUGIN);
    ...
    DDS_TypeImpl_set_programs(type_impl, programs);
    DDS_TypeImpl_set_typecode(type_impl,  BrakeCommand_get_typecode());

    return DDS_BOOLEAN_TRUE;
}
RTI_PRIVATE DDS_Boolean 
BrakeCommand_on_type_unregistered(struct DDS_TypeImpl* type_impl)
{
    struct RTIXCdrInterpreterPrograms *programs = NULL;
    programs = DDS_TypeImpl_get_programs(type_impl);
...
RTI_PRIVATE 
struct DDS_TypeEncapsulationI BrakeCommand_fv_XCDRv1PluginI =
{
    DDS_XCDR_DATA_REPRESENTATION,
    NULL,
    BrakeCommandEncapsulationKind,
    RTI_MEMORY_TYPE_HEAP,
    RTI_MEMORY_MANAGER_HEAP,
    NULL,
    NULL,
...
RTI_PRIVATE struct DDS_TypeEncapsulationI BrakeCommand_fv_XCDRv2PluginI =
{
    DDS_XCDR2_DATA_REPRESENTATION,
    NULL,
    BrakeCommandV2EncapsulationKind,
    RTI_MEMORY_TYPE_HEAP,
    RTI_MEMORY_MANAGER_HEAP,
    NULL,
    NULL,
...
RTI_PRIVATE struct DDS_TypeEncapsulationI *BrakeCommand_fv_WirePlugins[] =
{
    &BrakeCommand_fv_XCDRv2PluginI,
    &BrakeCommand_fv_XCDRv1PluginI,
    NULL
};

RTI_PRIVATE struct DDS_TypeMemoryI *BrakeCommand_fv_MemoryPlugins[] =
{
    &BrakeCommand_fv_XTypesHeapPluginI,

    NULL
};

RTI_PRIVATE struct DDS_TypePlugin*
BrakeCommandTypePlugin_create_plugin(
    DDS_DomainParticipant *participant,
    struct DDS_DomainParticipantQos *dp_qos,
    DDS_TypePluginMode_T endpoint_mode,
    DDS_TypePluginEndpoint *endpoint,
...
RTI_PRIVATE RTI_BOOL
BrakeCommandTypePlugin_delete_plugin(struct DDS_TypePlugin *plugin);

RTI_PRIVATE struct DDS_TypePluginI BrakeCommand_fv_TypePluginI =
{
    /**************************************************************************
    *                   Type information functions
    **************************************************************************/
    ...
    BrakeCommandTypePlugin_initialize_sample,
    ...
    NULL,
    NULL,
    BrakeCommand_fv_MemoryPlugins,
    BrakeCommand_fv_WirePlugins,

    /**************************************************************************
    *       Helper APIs to create language binding wrapper Functions
    **************************************************************************/

    BrakeCommandPlugin_create_typed_datawriter,
    #ifndef RTI_CERT
    BrakeCommandPlugin_delete_typed_datawriter,
    #else
    NULL,
    #endif
    BrakeCommandPlugin_create_typed_datareader,
    #ifndef RTI_CERT
    BrakeCommandPlugin_delete_typed_datareader,
    #else
    NULL,
    #endif
    BrakeCommandTypePlugin_create_plugin,
    BrakeCommandTypePlugin_delete_plugin,
    BrakeCommand_on_type_registered,
    BrakeCommand_on_type_unregistered,

};

/* --------------------------------------------------------------------------
*  Type BrakeCommand Plugin Methods
* -------------------------------------------------------------------------- */

struct DDS_TypePluginI*
BrakeCommandTypePlugin_get(void) 
{ 
    return &BrakeCommand_fv_TypePluginI;
} 
...
BrakeCommandTypePlugin_create_plugin(
    ...
    struct DDS_TypePluginProperty *const property)
{
    return DDS_TypePluginDefault_create(&BrakeCommand_fv_TypePluginI,
    participant,dp_qos,
    endpoint_mode,endpoint,qos,
    property);
}
...
{ 
    return BrakeCommandTYPENAME;
} 

NDDS_TypePluginKeyKind 
BrakeCommandI_get_key_kind(void)
{
    return BrakeCommand_fv_TypePluginI.key_kind;
}
